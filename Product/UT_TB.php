...
<table border="0" cellspacing="10px" class="tabs">
	<tr>
		...
		<td><a href="UT_TB.php" class="active">
...
<tr>
    <th class="th">NO</th>
     ...
     <th class="th">DATE</th>
     <th class="th">TIME</th>
     	<form align="center" method="post" action="UT_PDF.php">
     <th colspan="2">
		   <button type="submit" name="GenerateUTpdf" class="fas fa-file-pdf btnDelete"></button>
       </form>
     </th>
 </tr>
...
$TodaysDate=date("Y-m-d");
	...
	if ($dbconn) 
	{
		$Query="SELECT * FROM urine_test_register WHERE entryDate='$TodaysDate' ORDER BY entryTime DESC";
	    displayTB($dbconn,'UT_TB.php',$Query,'UT');
	}
	else
